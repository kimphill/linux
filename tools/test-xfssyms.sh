...
sudo ./usefs &
#exit    # going to run under debugger
sudo ./usefs &
sudo ./usefs &
sudo ./usefs &
sudo touch therecord; sudo chown $USER therecord
sudo ./perf record -vvvvv -a --call-graph dwarf sleep 0.1 >& therecord
sudo touch thereport; sudo chown $USER thereport
sudo ./perf report -vvvvv --stdio >& thereport
